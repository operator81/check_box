...
# прикручивание логотипа УрФУ
img = Image.open('test1.png').resize((130, 60))
logo = ImageTk.PhotoImage(img)
lable = Label(image=logo)
lable.pack()

# спикок для выпадающего окна
variants = ["выполнено", "выполнено частично", "не прикасался еще", "оставить на пересдачу"] 
